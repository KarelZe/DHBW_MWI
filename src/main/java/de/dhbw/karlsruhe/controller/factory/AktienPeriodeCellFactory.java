...
/**
 * Diese Klasse stellt Methoden für für die Überladung von ListViews mit eigenen {@code AktienPeriodeCell} bereit.
...
public class AktienPeriodeCellFactory implements Callback<ListView<Kurs>, ListCell<Kurs>> {
     ...
     *
     * @param param ListView, für das {@code AktienPeriodeCell} erzeugt wird
